function exibir(conteudo) {
    ...
    switch(conteudo) {
        ...
        case "04":
            ...
            pText = document.createTextNode('Ao contrário de a maioria dos desportos em que a duração do jogo é fixa por um tempo pré-determinado, no Baseball, para o jogo acabar, pelo menos uma equipe tem que fazer 27 eliminações, salvo raras exceções.');
            p3.appendChild(pText);
            modalidades.appendChild(p3);
        ...
        case "05":
            ...
            pText = document.createTextNode('As partidas são disputadas em meia-quadra com uma cesta. A quadra tem dimensões de 15×11 metros.');
            p4.appendChild(pText);
            modalidades.appendChild(p4);
        ...
        case "06":
			...
			textLi = document.createTextNode('Street - é praticado nas ruas como o próprio nome já diz ou em pistas que simulem ruas que tenham corrimões, escadas e rampas, dos mais variados tipos como spines, fun box, 45º, quarters, savanas entre outros.');
			item4.appendChild(textLi);
			list1.appendChild(item4);
